...
class UploadEventKotlinTest: BaseStartedTest() {
    ...
    fun testMPEventUploadBypass() {
        ...
        Server
            ...
            .assertWillNotReceive { it.body.any<MPEventMessage> { it.name == "Should Not Upload" } }.and
            .assertWillReceive {
    ...
    fun testMPScreenEventUploadBypass() {
        Server
            ...
            .assertWillReceive { it.body.any<ScreenViewMessage> { it.name == "Should Upload 1"} }.and
            .assertWillReceive { it.body.any<ScreenViewMessage> { it.name == "Should Upload 2"} }.and
            .assertWillReceive { it.body.any<ScreenViewMessage> { it.name == "Should Upload 3"} }.and
            .assertWillNotReceive { it.body.any<ScreenViewMessage> { it.name == "Should Not Upload" } }
            .after {
